...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: Step7Widget.routeName,
          path: Step7Widget.routePath,
          builder: (context, params) => Step7Widget(),
        ),
        FFRoute(
          name: Step8Widget.routeName,
          path: Step8Widget.routePath,
          builder: (context, params) => Step8Widget(),
        ),
        FFRoute(
