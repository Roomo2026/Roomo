...
/// Create a modern futuristic Signup Page for my AI Interior Design app using
/// the same dark glassmorphism theme as Login.
///
/// Theme:
/// BG #0B0F1A, Card #0F1424, Border #2A2F3F, Accent #7C5CFF, Gradient #7C5CFF
/// → #A855F7.
///
/// Layout:
/// Centered glass card (max width 420, radius 20) with neon violet glow
/// shadow.
///
/// Inside:
/// Title “Create Your AI Space” 28 bold white.
/// Subtitle muted text.
/// Email field (same login style).
/// Password field (min 6 validation).
/// Confirm Password field (must match password).
///
/// Button:
/// “Create Account”, height 52, radius 16, violet gradient, glow shadow.
///
/// Actions:
/// Validate email not empty, password ≥6, confirm match.
/// Firebase Auth → Create Account (auto login).
/// On success create Firestore doc:
/// Collection users, ID currentUserUid.
/// Fields: uid, email, createdAt timestamp, role “user”, isPremium false.
/// Navigate HomePage (clear stack).
/// On error show snackbar.
///
/// Bottom:
/// “Already have an account? Login” → navigate.
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [Color(0xFF0B0F1A), Color(0xFF1A1F2E)],
                stops: [0.0, 1.0],
                          ...
                          Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  controller: _model
                                      .createConfirmPasswordTextController,
                                  focusNode:
                                      _model.createConfirmPasswordFocusNode,
                                  autofocus: false,
                                  autofillHints: [AutofillHints.newPassword],
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    if (_model.createPasswordTextController
                                            .text !=
                                        _model
                                            .createConfirmPasswordTextController
                                            .text) {
