      ...
      child: Scaffold(
        ...
        floatingActionButton: Padding(
          ...
          child: FloatingActionButton.extended(
            onPressed: () async {
              if (_model.selectedMode == null || _model.selectedMode == '') {
                ...
                var projectsRecordReference =
                    ProjectsRecord.createDoc(currentUserReference!);
                await projectsRecordReference.set({
                  ...createProjectsRecordData(
                    selectedMode: _model.selectedMode,
                    step: 1,
                    status: 'draft',
                  ),
                  ...mapToFirestore(
                ...
                _model.createdProject = ProjectsRecord.getDocumentFromData({
                  ...createProjectsRecordData(
                    selectedMode: _model.selectedMode,
                    step: 1,
                    status: 'draft',
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFF342963),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Full redesign or style transfer',
                          style: FlutterFlowTheme.of(context)
                              .headlineMedium
                              .override(
                                font: GoogleFonts.interTight(
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            _model.selectedMode = 'full_redesign';
                            safeSetState(() {});
                          },
                          child: Container(
                            width: 300.0,
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if (_model.selectedMode == 'full_redesign')
                                    Icon(
                                      Icons.check_circle,
                                      color:
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if (_model.selectedMode == 'refresh')
                                    Icon(
                                      Icons.check_circle,
                                      color:
                                          FlutterFlowTheme.of(context).primary,
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            _model.selectedMode = 'Style only';
                            safeSetState(() {});
                          },
                          child: Container(
                            width: 300.0,
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  if (_model.selectedMode == 'Style only')
                                    Icon(
                                      Icons.check_circle,
                                      color:
                                          FlutterFlowTheme.of(context).primary,
