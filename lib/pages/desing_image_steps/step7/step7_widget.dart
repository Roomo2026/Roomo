...
import 'step7_model.dart';
export 'step7_model.dart';

class Step7Widget extends StatefulWidget {
  const Step7Widget({super.key});

  static String routeName = 'step7';
  static String routePath = '/step7';
...
class _Step7WidgetState extends State<Step7Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Step7Model());
  }
