    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            if (_model.selectedImageUrl == null || _model.selectedImageUrl == ''
                ? false
                : false) {
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (selectedMedia != null &&
                              ...
                              safeSetState(() =>
                                  _model.isDataUploading_uploadData5wj = true);
                              var selectedUploadedFiles = <FFUploadedFile>[];
                              ...
                              try {
                                ...
                                _model.isDataUploading_uploadData5wj = false;
                              }
                              if (selectedUploadedFiles.length ==
                                      selectedMedia.length &&
                                  downloadUrls.length == selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadData5wj =
                                      selectedUploadedFiles.first;
                                  _model.uploadedFileUrl_uploadData5wj =
                                      downloadUrls.first;
                                });
                              } else {
                                safeSetState(() {});
                      ...
                      onTap: () async {
                        ...
                        if (selectedMedia != null &&
                            selectedMedia.every((m) =>
                                validateFileFormat(m.storagePath, context))) {
                          safeSetState(() =>
                              _model.isDataUploading_uploadGallery = true);
                          var selectedUploadedFiles = <FFUploadedFile>[];
                          ...
                          try {
                            ...
                            _model.isDataUploading_uploadGallery = false;
                          }
                          if (selectedUploadedFiles.length ==
                                  selectedMedia.length &&
                              downloadUrls.length == selectedMedia.length) {
                            safeSetState(() {
                              _model.uploadedLocalFile_uploadGallery =
                                  selectedUploadedFiles.first;
                              _model.uploadedFileUrl_uploadGallery =
                                  downloadUrls.first;
                            });
                          } else {
                            safeSetState(() {});
              ...
              if (_model.selectedImageUrl != null &&
                  _model.selectedImageUrl != '')
                Padding(
