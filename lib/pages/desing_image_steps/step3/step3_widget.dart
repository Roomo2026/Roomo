    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            if (_model.selectedRoomType == null || _model.selectedRoomType == ''
                ? false
                : false) {
              ...
              await FFAppState().currentProjectRef!.update({
                ...createProjectsRecordData(
                  step: 3,
                  status: 'draft',
                  roomType: _model.selectedRoomType,
                ),
                ...mapToFirestore(
                  {
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                _model.selectedRoomType = 'Bedroom';
                                safeSetState(() {});
                              },
                              child: Container(
                                width: 300.0,
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      if (_model.selectedRoomType == 'Bedroom')
                                        Icon(
                                          Icons.check_circle,
                                          color: FlutterFlowTheme.of(context)
                                              .primary,
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                _model.selectedRoomType = 'Kitchen';
                                safeSetState(() {});
                              },
                              child: Container(
                                width: 300.0,
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      if (_model.selectedRoomType == 'Kitchen')
                                        Icon(
                                          Icons.check_circle,
                                          color: FlutterFlowTheme.of(context)
                                              .primary,
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                _model.selectedRoomType = 'Bathroom';
                                safeSetState(() {});
                              },
                              child: Container(
                                width: 300.0,
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      if (_model.selectedRoomType == 'Bathroom')
                                        Icon(
                                          Icons.check_circle,
                                          color: FlutterFlowTheme.of(context)
                                              .primary,
