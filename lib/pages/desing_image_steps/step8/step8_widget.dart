...
import 'step8_model.dart';
export 'step8_model.dart';

class Step8Widget extends StatefulWidget {
  const Step8Widget({super.key});

  static String routeName = 'step8';
  static String routePath = '/step8';
...
class _Step8WidgetState extends State<Step8Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Step8Model());
  }
